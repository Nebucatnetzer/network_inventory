...
def test_customer_license_table(create_admin_user):
    ...
    computer_license = mixer.blend(
        "licenses.ComputerLicense",
        customer=customer,
        software=mixer.SELECT,
        key=mixer.RANDOM,
    ...
    assert (
        ...
        and helper.in_content(response, computer_license.max_allowed_computers)
    )
